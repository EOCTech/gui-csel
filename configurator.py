...
def writeToConfig(name,points,enabled,keywords):
        f = open((str(usrDsktp.get())+'csel.cfg'),'a')
        if enabled == 1:
          line1 = name+'=(y)\n'
...
userDesktopLabel = Label(root,text="Path to Desktop?(i.e. /home/user/Desktop/")
...
userDesktop.grid(row=0,column=1)
userDesktopLabel.grid(row=0,column=2,sticky=W)
